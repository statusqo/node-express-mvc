...
module.exports = {
  ...
  async index(req, res) {
    ...
    res.render("admin/event-timeline/index", {
      title: "Events",
      events,
      timeline,
      timelineHasToday,
  ...
  async registrantEditForm(req, res) {
    ...
    if (!event) {
      ...
      return res.redirect((req.adminPrefix || "") + "/event-timeline");
    }
    ...
    res.render("admin/event-timeline/registrant-edit", {
  ...
  async registrants(req, res) {
    ...
    res.render("admin/event-timeline/registrants", {
      title: "Registrants",
      event,
      registrants,
      paidRegistrantCount,
